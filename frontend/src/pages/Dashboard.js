...
import { Container, TextField, Button, Typography, Card, CardContent, IconButton, Grid } from '@mui/material';
...
function Dashboard() {
    ...
    const filteredFlashcards = flashcards.filter(flashcard => 
        (flashcard.question && flashcard.question.toLowerCase().includes(searchTerm.toLowerCase())) ||
        (flashcard.answer && flashcard.answer.toLowerCase().includes(searchTerm.toLowerCase()))
    );
                    ...
                    <Grid item xs={12} sm={6} md={4} key={flashcard.id}>
                        <Card>
                            <CardContent>
                                ...
                                <IconButton color="primary" onClick={() => handleEdit(flashcard.id)}>
                                    <Edit />
                                </IconButton>
                                <IconButton color="secondary" onClick={() => handleDelete(flashcard.id)}>
                                    <Delete />
                                </IconButton>
                            </CardContent>
                        </Card>
